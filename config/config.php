<?php
  ...
  */
  ...
  DEFINE('SEM_VER_DOM1','18-12');
  DEFINE('SEM_VER_LUN','19-12');
  DEFINE('SEM_VER_MAR','20-12');
  DEFINE('SEM_VER_MIE','21-12');
  DEFINE('SEM_VER_JUE','22-12');
  DEFINE('SEM_VER_VIE','23-12');
  DEFINE('SEM_VER_SAB','24-12');
  DEFINE('SEM_VER_DOM2','25-12');
